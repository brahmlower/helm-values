...
# Shamelessly copied from https://github.com/dadav/helm-schema/refs/heads/main/install-binary.sh

PROJECT_NAME="helm-values"
BINARY_NAME="helm-values"
PROJECT_GH="brahmlower/$PROJECT_NAME"
